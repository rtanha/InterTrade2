report 50010 "Lot List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src\Layout\Lot List.rdlc';
    CaptionML = ENU = 'Lot List per Location', DEU = 'Chargenliste pro Lagerort';
    ApplicationArea = all;
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                begin
                    if Reservierungberechnen.READ then
                        QuantitySalesOrder := Reservierungberechnen.Sum_Quantity;
                end;
