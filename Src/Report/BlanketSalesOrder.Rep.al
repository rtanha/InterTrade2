report 50007 "Blanket Sales Order (INT)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src\Layout\Blanket Sales Order Inter.rdlc';
    CaptionML = ENU = 'Blanket Sales Order', DEU = 'Rahmenauftrag';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(SumOfMyField; SumOfMyField)
            {
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                group(Optionen)
                {
                    CaptionML = ENU = 'Options', DEU = 'Optionen';
                    field(NoOfCopies; NoOfCopies)
                    {
                        CaptionML = ENU = 'No. of Copies', DEU = 'Anzahl Kopy';
                    }
                    field(ShowInternalInfo; ShowInternalInfo)
                    {
                        CaptionML = ENU = 'Show Internal Information', DEU = 'Interne Informationen anzeigen';
                    }
                    field(ArchiveDocument; ArchiveDocument)
                    {
                        CaptionML = ENU = 'Archive Document', DEU = 'Beleg archivieren';
                    ...
                    {
                        CaptionML = ENU = 'Log Interaction', DEU = 'Aktivität protokollieren';
                    ...
                    {
                        CaptionML = ENU = 'Show Assembly Components', DEU = 'Montagekomponenten anzeigen';
                    }
                    field(WithHeader; WithHeader)
                    {
                        CaptionML = ENU = 'With Header', DEU = 'Mit Briefkopf';
                    }
                }
            }
        }
    ...
    var
        ...
        Text003: Label 'COPY';
        Text004: Label 'Framework Contract %1';
